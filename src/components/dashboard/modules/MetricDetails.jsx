...
const MetricDetails = ({ projectId, companyID_, onBack }) => {
            ...
            <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6">
                ...
                <div className="lg:w-1/2 flex flex-col justify-center p-4 space-y-4 bg-white rounded-lg shadow">
                    <div className="bg-white p-4 rounded-lg shadow-lg">
                        ...
                        <p><strong>Budget:</strong> ${project.inversion}</p>
                        <p><strong>Deadline:</strong> 24/07/2024</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-lg">
                        <p><strong>Tasks completed:</strong> 54</p>
                        <p><strong>Tasks pending:</strong>  1</p>
                        <div className="flex items-center">
                            <p className="mr-2"><strong>Progress:</strong></p>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-lg">
                        ...
                        <p><strong>Cost per Task:</strong> ${costPerTask.toFixed(2)}</p>
                        <p><strong>Time Remaining:</strong> {Math.ceil(timeRemaining / (1000 * 60 * 60 * 24))} days</p>
                    </div>
                </div>
            </div>
        </div>
