        ...
        <div className="rounded-lg bg-white h-fit flex flex-col p-8">
            <div className="flex items-center space-x-6 relative">
                ...
                <div>
                    ...
                    <p className="text-xl text-gray-600">{user.position} at {user.company}</p>
            ...
            <div className="mt-8">
                ...
                <form className="mt-6 space-y-6">
                    <div>
                        <label className="block text-xl text-gray-900">Name</label>
                    ...
                    <div>
                        <label className="block text-xl text-gray-900">Company</label>
                        <label className="block text-lg text-gray-600">{user.company}</label>
                    </div>
                    <div>
                        <label className="block text-xl text-gray-900">Position</label>
