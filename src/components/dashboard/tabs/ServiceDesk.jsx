...
import ViewTicket from '../modules/ViewTicket';
...
const ServiceDesk = () => {
    ...
    return (
        <div className="rounded-lg bg-white h-full flex flex-col p-6">
            {editingTicket ? (
                <ViewTicket ticket={editingTicket} onBack={handleBackToTable} />
            ) : (
                <>
                    ...
                    {showCreateModal && <CreateTicketModal onClose={() => setShowCreateModal(false)} onCreateTicket={handleCreateTicket} />}
                    {showFilterModal && (
                        <FilterTicketsModal
