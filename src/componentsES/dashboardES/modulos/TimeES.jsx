...
const Time = () => {
    ...
    return (
        <div className="rounded-lg bg-white h-full flex flex-col justify-start p-4">
            <h1 className="text-center font-poppins font-semibold mb-4">Resumen de ahorros</h1>
            <div className='flex-grow flex flex-col justify-center'>
                <h1 className="text-center font-poppins font-semibold text-4xl">Tiempo ahorrado</h1>
                ...
                <h1 className="text-center font-poppins font-semibold text-4xl mt-4">Dinero ahorrado</h1>
                <h2 className="text-center font-poppins font-semibold text-4xl bg-clip-text text-transparent mt-4"
                    style={{
                        backgroundImage: 'linear-gradient(to right, #E3494D 25%, #6200D1 55%, #6310C0 75%)'
                    }}>
