...
import ActivityDetails from '../modulos/ActivityDetailsES';
import { useNavigate } from 'react-router-dom';

const ActivityES = ({ CompanyID_ }) => {
    ...
    return (
        <div className="rounded-lg bg-white h-full flex flex-col p-3">
            <h1 className="text-center font-poppins font-semibold mb-4">Actividad</h1>
            {!selectedProjectId && (
            ...
            {selectedProjectId ? (
                <ActivityDetails companyID_={CompanyID_} projectId={selectedProjectId} onBack={() => setSelectedProjectId(null)} />
            ) : (
                isMobileView ? (
