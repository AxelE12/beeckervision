...
import CreateTicketModalES from '../../modalES/CreateTicketModalES';
import FilterTicketsModalES from '../../modalES/FilterTicketsModalES';
import ViewTicketES from '../modulos/ViewTicketES';
...
const ServiceDeskES = () => {
    ...
    const isClient = () => companyName !== 'Beecker';
    ...
    return (
        <div className="rounded-lg bg-white h-full flex flex-col p-6">
            {editingTicket ? (
                <ViewTicketES ticket={editingTicket} onBack={handleBackToTable} />
            ) : (
                <>
                    ...
                    {showCreateModal && <CreateTicketModalES onClose={() => setShowCreateModal(false)} onCreateTicket={handleCreateTicket} />}
                    {showFilterModal && (
