...
const FilterTicketsModalES = ({ onClose, onApplyFilters }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-8 w-full max-w-md relative">
                ...
                <h2 className="text-lg font-poppins font-semibold text-center mt-2 mb-4 text-gray-700">Filtrar Tickets</h2>
                <form className="space-y-4">
                                    ...
                                    <MenuItem>
                                        {({ active }) => (
                                            <div
                                                ...
                                                onClick={() => setStatus('Esperando respuesta')}
                                            >
                                                Esperando respuesta
                                            </div>
                                        )}
                    ...
                    <div>
                        ...
                        <Menu as="div" className="relative inline-block w-full text-left">
                            <div>
                                <MenuButton className="inline-flex w-full justify-between rounded-md bg-purple-50 px-3 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-100">
                                    {priority || "Selecciona una opción"}
                                    <ChevronDownIcon className="-mr-1 h-5 w-5 text-gray-400" aria-hidden="true" />
                                </MenuButton>
                            </div>
                            <Transition
...
export default FilterTicketsModalES;
